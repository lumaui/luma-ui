...
Este Design System define **princípios estruturais, visuais e comportamentais** para a criação de interfaces baseadas no **Neo‑Minimalismo**.

Ele **não descreve componentes**, nem dita implementações específicas. Seu papel é servir como **base conceitual permanente**, aplicável a qualquer novo componente, layout ou padrão que venha a ser criado.

> **Regra-mãe:** se um componente viola estes princípios, ele não pertence ao sistema — mesmo que seja bonito.

---

## 2. Fundamentos do Neo‑Minimalismo

O Neo‑Minimalismo parte da maturidade do minimalismo clássico e adiciona **humanidade, fluidez e contexto**.
...
## 4. Whitespace Funcional

Whitespace é **estrutura invisível**.
...
⚠️ Não existe um raio fixo obrigatório.
O raio correto é aquele que **não chama atenção para si**.

---

## 6. Luz como Estrutura (não decoração)
...
## 8. Tipografia como Elemento Central

A tipografia é o principal componente visual do sistema.
