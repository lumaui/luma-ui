...
describe('CardComponent', () => {
  ...
  it('should apply wrapper classes with gradient border technique', () => {
    ...
    expect(wrapperClasses).toContain('rounded-luma-lg');
    expect(wrapperClasses).toContain('p-[1px]');
    expect(wrapperClasses).toContain('bg-gradient-to-b');
    expect(wrapperClasses).toContain('from-card-gradient-from');
    expect(wrapperClasses).toContain('to-card-gradient-to');
  });
  ...
  it('should apply content classes with background and padding', () => {
    ...
    expect(contentClasses).toContain('bg-card-background');
    expect(contentClasses).toContain('p-card-padding');
    expect(contentClasses).toContain('text-text-primary');
  });
