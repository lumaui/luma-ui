...
@Component({
  template: `<h3 lumaCardTitle [size]="size">Test Title</h3>`,
...
@Component({
  template: `<p lumaCardDescription [size]="size">Test Description</p>`,
...
@Component({
  template: `
    <div lumaCardHeader>
      <h3 lumaCardTitle size="large">Integration Test</h3>
      <p lumaCardDescription size="small">Testing all directives together</p>
    </div>
    <div lumaCardContent>
      <p>Content area</p>
    </div>
