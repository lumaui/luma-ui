...
/**
 * Filtra quais tokens devem gerar referências CSS var() vs valores hardcoded.
 * Isso habilita composição de tokens em runtime.
 *
 * Estratégia:
 * - Core tokens (color, spacing, etc.): Valores reais (fonte da verdade)
 * - Component tokens com referências: var() (composição dinâmica)
 * - Tokens sem referências: Valores diretos
 *
