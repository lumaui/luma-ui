...
--color-primary-2: oklch(0.94 0.02 300);
--color-primary-3: oklch(0.88 0.035 300);
--color-primary-4: oklch(0.78 0.06 300);
--color-primary-5: oklch(0.48 0.09 300); /* BASE COLOR */
--color-primary-6: oklch(0.43 0.085 300);
--color-primary-7: oklch(0.38 0.08 300);
...
--shadow-6: 0 16px 32px 0 oklch(0 0 0 / 0.1), 0 0 0 1px oklch(0.5 0 0 / 0.02);
```
...
```css
/* Destructive */
--color-destructive-background: oklch(0.63 0.1 28);
--color-destructive-foreground: oklch(1 0 0);

/* Warning */
--color-warning-background: oklch(0.8 0.09 95);
...
--color-primary-1: oklch(0.13 0.03 300); /* Very dark */
--color-primary-5: oklch(0.72 0.12 300); /* BASE - brighter in dark mode */
--color-primary-12: oklch(0.98 0.02 300); /* Nearly white */

/* Semantic colors adjusted */
--color-destructive-background: oklch(0.55 0.12 28);
--color-warning-background: oklch(0.7 0.1 95);
