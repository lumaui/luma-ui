...
import { textareaVariants, type TextareaSize } from '@lumaui/core';
...
export class LmTextareaDirective implements ControlValueAccessor, OnInit {
  ...
  // Auto-generated ID
  elementId = signal<string>(`luma-textarea-${textareaIdCounter++}`);
